    ...
    <section id="home" className="relative overflow-hidden">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center py-24 sm:py-32 lg:py-40">
          <h1 className="text-2xl sm:text-5xl lg:text-7xl font-normal tracking-tight text-foreground/90 leading-tight flex flex-col items-center gap-4">
            <span className="relative block bg-gradient-to-r from-secondary/40 to-secondary/10 px-2 sm:px-4 md:pl-8 md:pr-6 py-2 border-l-4 border-secondary whitespace-nowrap">
